...
class MenuPage extends React.Component {
  ...
  render() {
    ...
    const contentHeight = this.props.isHeightBounded ? '100%' : this.props.height;

    return (
      <div
        ref={this.props.refCallback}
        className={cx(['content', { 'hidden-page': this.props.isHidden }])}
        style={{ height: contentHeight, width: this.props.width }}
      >
...
MenuPage.childContextTypes = childContextTypes;
